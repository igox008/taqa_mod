...
def initialize_classifier():
    ...
    try:
        # Use the simple reliable system
        from simple_hybrid_api import SimpleTAQAAPI
        classifier_api = SimpleTAQAAPI()
        print("✅ TAQA Simple System loaded successfully!")
        print("🎯 Lookup + Text Analysis - Always works!")
        print("🤖 Using: Lookup system + Smart text analysis")
        return True
